...
export async function triageMaintenance(params: {
  ...
  const prompt = [
    ...
    "• Mailbox issues",
    "",
    "NOT_MAINTENANCE (urgencyHours: null) — Not a maintenance request at all:",
    "• Simple acknowledgements: 'ok', 'thanks', 'sure', 'got it', 'will do', 'noted', etc.",
    "• Greetings: 'hi', 'hello', 'hey', 'good morning', etc.",
    "• Casual conversation, compliments, or social messages",
    "• Responses to reminders (e.g., 'ok I'll pay tomorrow')",
    "• Questions about non-maintenance topics (lease terms, move-out dates, etc.)",
    "• Any message that does NOT describe a physical issue, damage, malfunction, or hazard",
    "",
    ...
    '  "classification": {',
    '    "severity": "critical|high|normal|low|not_maintenance",',
    ...
    "If the message is NOT about a maintenance issue at all (acknowledgement, greeting, question, social chat), classify as 'not_maintenance'.",
    "",
    "--- RTA SKILL ---",
    rtaSkill,
