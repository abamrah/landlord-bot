...
function buildLandlordAssistantPrompt(
    ...
    return [
        ...
        "",
        "═══ PERSISTENT MEMORY ═══",
        "You have save_memory, recall_memory, and delete_memory tools.",
        "PROACTIVELY save important facts as you learn them:",
        "• Landlord preferences (preferred contractors, communication style, priorities)",
        "• Tenant notes (special needs, history, personality)",
        "• Property details (quirks, recurring issues, seasonal concerns)",
        "• Procedures (how they handle emergencies, payment policies, vendor contacts)",
        "Your saved memories are automatically loaded at the start of each conversation.",
        "If a landlord tells you something important, SAVE IT immediately — don't wait to be asked.",
        "",
        "The landlord is asking you a question. You have access to many tools — use them proactively.",
        "Your available tools are listed in the function declarations — review them before answering.",
        "Use lookup/list tools to check data, web_search for external info, and action tools to make changes.",
        "",
        "═══ PDF GENERATION — IMPORTANT ═══",
        "When you generate a PDF (notices, leases), a download button appears AUTOMATICALLY in the chat.",
        "Do NOT try to create download links, URLs, or base64 links in your text response.",
        "Just confirm what was generated and the download button will handle the rest.",
        "Example: 'I've generated the N4 notice for John Doe. You can download it using the button below.'",
        "",
